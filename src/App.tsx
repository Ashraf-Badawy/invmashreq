...
import { exportMovementsToExcel as exportMovementsToExcelHelper } from './excelExport';
import { 
  BarChart, 
  Bar, 
  XAxis, 
...
export default function App() {
  ...
  const exportMovementsToExcel = (fileName: string) => {
    exportMovementsToExcelHelper(items, transactions, orders, reportStartDate, reportEndDate, fileName);
  };
